 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
						   ...
						   <p class="about-para-w3ls">Sunrise is an iconic luxury hotel situated in India. The Sunrise is renowned for its opulent architecture, rich history, and exceptional hospitality.</p>
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
                                       ...
                                       <div class="w3ls-info-about">
											...
											<p>Where you will be, we will be with you </p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
			...
			<div id="horizontalTab">
					...
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Alex Jorden</h4>
							<span>Manager</span>
							<p>The Sunrise offers an array of luxurious accommodations, dining options, and recreational facilities, ensuring an unforgettable experience for every visitor. With its impeccable service, breathtaking views, and timeless charm</p>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Address :</strong> Bangolre, India</p>
